    ...
    var n = {
        ...
        sideNav: function () {
            o("#side-nav-open").click(function () {
                o("#side-nav").css("width", "300"), setTimeout(function () {
                ...
                setTimeout(function () {
                    ...
                    o("body").removeClass("sidenav-open"), o("#side-nav").css("width", "0")
                }, 400)
            }), o("#side-search-open").click(function () {
                o("#side-search").css("width", "300"), setTimeout(function () {
                ...
                setTimeout(function () {
                    ...
                    o("body").removeClass("sidesearch-open"), o("#side-search").css("width", "0")
                }, 300)
            })
        }
    };
...
function scrollFunction() {
    if (document.body.scrollTop > 550 || document.documentElement.scrollTop > 4400) {
